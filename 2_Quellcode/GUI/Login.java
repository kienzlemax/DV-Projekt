...
/**
 * 
 * public class Login generates a JFrame (GUI) for our Login interface for our ToDoList.
 * 
 * @author MaxKienzle
 *
 */
...
public class Login extends JFrame {
	...
	public Login() {
		 ...
		 * the left darker part of the panel is set.
		 * with all the parameters like color, Bounds and where it is added to.
		 * 
		 * @author MaxKienzle
		*/
		...
		*/
		...
		/**
		 * Initialize and generates a Login-Button with his ActionListener, which is used for different commands.
		 * 
		 * If you click on the Login-Button the Code will check what is written in to the tfEmail-TextFiel
		 * and what is written in to the txtPasswordField. After that it compares, if it is equal to the E-Mail
		 * from the Database with his related matriculation number. If that is all right, the DashboardWindow will open, 
		...
		btnLogin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(user.equals("kienzle-maximilian@t-online.de") && password.equals("266371")) { //controls the E-Mail and Number
				Login.this.dispose();
				Dashboard frame = new Dashboard();
				frame.setUndecorated(true); 
				frame.setVisible(true);}  // opens Dashboard without the Frame
				
				else lblretry.setText("Login fehlgeschlagen, bitte erneut versuchen!!!"); // Error is issued
		...
		*/
		 ...
		 * If it is clicked, the Login-Screen will pop up again.
		 * 
		 * @author MaxKienzle
		 */
